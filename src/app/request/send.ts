...
export async function sendRequest (  body: DataType) {
    try {
        ...
        let header =  headers().set('.AspNet.Cookies', 'asdf')
        console.log(header);
        // console.log(res);
